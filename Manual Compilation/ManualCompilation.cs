...
namespace XDFramework.Editor
{
    ...
    public sealed class ManualCompilation : AssetPostprocessor
    {
        ...
        public const string RECOMPILE_ICON_PATH = "Manual Compilation/icon_recompile";
        public const string RECOMPILE_AND_PLAY_ICON_PATH = "Manual Compilation/icon_recompile and play";
        public const string REFRESH_ICON_PATH = "Manual Compilation/icon_refresh";
